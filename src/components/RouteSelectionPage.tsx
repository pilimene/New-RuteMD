  ...
  const routes = [
    {
      ...
      via: "Varna, Burgas",
      price: 50,
      image: "https://images.unsplash.com/photo-1617988995031-6d42638a1547?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpc3RhbmJ1bCUyMHR1cmtleSUyMGJvc3Bob3J1cyUyMGJyaWRnZSUyMGJsdWUlMjBob3VyfGVufDF8fHx8MTc2NDc5MDY5N3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      id: 3,
      origin: "Istanbul",
    ...
    },
    {
      ...
      via: "Otopeni",
      price: 30,
      image: "https://images.unsplash.com/photo-1561317180-c17135064d76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyb21hbmlhbiUyMGF0aGVuYWV1bSUyMGJ1Y2hhcmVzdCUyMG5pZ2h0fGVufDF8fHx8MTc2NDc5MDY5OHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    }
  ];

  const groups = [
    { title: "Turcia și Bulgaria", routes: routes.filter(r => r.destination === "Istanbul" || r.origin === "Istanbul") },
    { title: "România", routes: routes.filter(r => r.destination === "București") }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              Oferim transport regulat către cele mai populare destinații. Alege ruta dorită pentru a vedea toate detaliile.
            </p>
          </div>
              ...
              <div key={group.title}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {group.routes.map((route) => (
                    <Link to="/route-details" key={route.id} className="group">
                          ...
                          <div className="flex justify-between items-start">
                             <div className="bg-white/10 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/20">
                               <span className="text-sm font-medium flex items-center gap-2">
                                 <Clock className="w-4 h-4" /> Zilnic
                               </span>
                             </div>
