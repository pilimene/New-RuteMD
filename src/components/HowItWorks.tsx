...
const steps = [
  {
    icon: Calendar,
    title: '1. Alege Ruta',
    description: 'Selectează destinația și data plecării din calendarul nostru.',
  },
  {
    icon: Ticket,
    title: '2. Rezervă',
    description: 'Confirmă locul rapid online sau telefonic.',
  },
  {
    icon: Bus,
    title: '3. Călătorește',
    description: 'Relaxează-te la bordul autocarelor noastre premium.',
  },
];
    ...
    <section className="py-16 bg-gradient-to-br from-[#012141] to-[#001a30] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          <span className="text-[#3870db] font-bold tracking-wider uppercase text-xs">Proces Simplificat</span>
          <h2 className="text-3xl md:text-4xl font-bold mt-2">Trei pași simpli</h2>
        </div>
